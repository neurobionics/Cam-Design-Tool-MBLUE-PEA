...
tasktitlelist{1} = 'Squat';
tasktitlelist{2} = 'Level';
tasktitlelist{3} = 'Ramp Up';
tasktitlelist{4} = 'Ramp Down';
...
%     set(hfig,'Units','centimeters','Position',[3 3 picturewidth hw_ratio*picturewidth])
    set(hfig,'Units','centimeters','Position',[3.0000    3.0000   23.8464   21.5533])
